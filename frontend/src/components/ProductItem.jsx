...
const ProductItem = ({id,image,name,price}) => {
  ...
  return (
    <Link onClick={()=>window.scrollTo(0,0)} to={`/product/${id}`} className='border border-gray-300 group shadow-md hover:shadow-2xl duration-300 rounded-md overflow-hidden '>
